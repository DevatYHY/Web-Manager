...
import 'package:trellocards/Loginform.dart';
                ...
                Expanded(
                  ...
                  child: Container(
                    child: Align(
                      ...
                      child: Image.asset('images/skywa.png', height: heightSize * 0.5, width: widthSize * 0.5, semanticLabel: 'test'),
                    )
                  )
                ),
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset('images/logo.png', height: heightSize * 0.2, width: widthSize * 0.15),
                        SizedBox(height: 20),
                        LoginForm(
